...
public class TerminalTreebankNode_Type extends TreebankNode_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.cleartk.syntax.constituent.type.TerminalTreebankNode");
  ...
  public int getIndex(int addr) {
      ...
      jcas.throwFeatMissing("index", "org.cleartk.syntax.constituent.type.TerminalTreebankNode");
  ...
  public int getTokenIndex(int addr) {
      ...
      jcas.throwFeatMissing("tokenIndex", "org.cleartk.syntax.constituent.type.TerminalTreebankNode");
