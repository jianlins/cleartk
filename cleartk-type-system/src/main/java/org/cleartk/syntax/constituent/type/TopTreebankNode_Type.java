...
public class TopTreebankNode_Type extends TreebankNode_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.cleartk.syntax.constituent.type.TopTreebankNode");
  ...
  public String getTreebankParse(int addr) {
      ...
      jcas.throwFeatMissing("treebankParse", "org.cleartk.syntax.constituent.type.TopTreebankNode");
  ...
  public int getTerminals(int addr) {
      ...
      jcas.throwFeatMissing("terminals", "org.cleartk.syntax.constituent.type.TopTreebankNode");
